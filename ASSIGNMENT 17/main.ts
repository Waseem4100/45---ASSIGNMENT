...
//using splice to a value in the middle index of an array
 ...
 guest.map((items)=> console.log(`${items} you have been invited to the dinner`));
...
while(guest.length>2){
    ...
    console.log (`sorry ${removedguest} i can't invite youthe dinner`)
};

while(guest.length >0){
    let newlist = guest.pop ()
    console.log(`${newlist} you are still invited to the dinner`)
};
console.log(guest);
